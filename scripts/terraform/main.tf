...
module "ecs" {
  ...
  instance_image_id  = var.Version == "hive3.1.3-arm-v1.0" ? local.instance_image_id_maps_v1[data.huaweicloud_availability_zones.az.region] : local.instance_image_id_maps_v1[data.huaweicloud_availability_zones.az.region] 
